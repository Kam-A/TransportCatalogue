...
PROTOBUF_NAMESPACE_OPEN
template<> ::transport_catalogue_serialize::RouterSettings* Arena::CreateMaybeMessage<::transport_catalogue_serialize::RouterSettings>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace transport_catalogue_serialize {
...
class RouterSettings final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:transport_catalogue_serialize.RouterSettings) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "transport_catalogue_serialize.RouterSettings";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:transport_catalogue_serialize.RouterSettings)
 private:
  class _Internal;
...
// int32 time = 1;
inline void RouterSettings::clear_time() {
  time_ = 0;
}
inline int32_t RouterSettings::_internal_time() const {
  return time_;
}
inline int32_t RouterSettings::time() const {
  // @@protoc_insertion_point(field_get:transport_catalogue_serialize.RouterSettings.time)
  return _internal_time();
}
inline void RouterSettings::_internal_set_time(int32_t value) {
  
  time_ = value;
}
inline void RouterSettings::set_time(int32_t value) {
  _internal_set_time(value);
  // @@protoc_insertion_point(field_set:transport_catalogue_serialize.RouterSettings.time)
}

// double velocity = 2;
inline void RouterSettings::clear_velocity() {
  velocity_ = 0;
}
inline double RouterSettings::_internal_velocity() const {
  return velocity_;
}
inline double RouterSettings::velocity() const {
  // @@protoc_insertion_point(field_get:transport_catalogue_serialize.RouterSettings.velocity)
  return _internal_velocity();
}
inline void RouterSettings::_internal_set_velocity(double value) {
  
  velocity_ = value;
}
inline void RouterSettings::set_velocity(double value) {
  _internal_set_velocity(value);
  // @@protoc_insertion_point(field_set:transport_catalogue_serialize.RouterSettings.velocity)
}
